...
// Task periods in ms
const uint16_t adc_task_period = 50;
const uint16_t blink_task_period = 40;
...
void adc_task() {
    ...
    case SAMPLE:
        ...
        // otherwise, remain in SAMPLE state
        mPORTBToggleBits(BIT_7);
        break;

    // next phase (drawing) takes 130 times longer (13 ms):
    // tft_printLine:  9 ms
    // tft_fillCircle: 2 ms
    // tft_fillCircle: 2 ms
    case ERASE:
