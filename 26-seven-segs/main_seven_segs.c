...
// PORT B (segments)
#define SEGA BIT_7  // pin 11 of display
#define SEGB BIT_8  // pin 7
#define SEGC BIT_9  // pin 4
#define SEGD BIT_10 // pin 2
#define SEGE BIT_3  // pin 1
#define SEGF BIT_13 // pin 10
#define SEGG BIT_4  // pin 5
#define SEGH BIT_15 // pin 3, decimal point
